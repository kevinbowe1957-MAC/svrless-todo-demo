...
export const handler = async (event, context) => {
    ...
    //------------------------------------------------
    try {
        //--VALID TEST DATA - Passed with Lambda > Test -- { "body": { "id": 999999 } }
        //--VALID TEST DATA - Passed with PostMan -- { "id": 999999 }
        ...
        body = `Delete item ${requestJSON.id}  --  Event source a String: ${isSourceString}`;
